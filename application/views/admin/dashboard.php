...
<div class="container-fluid">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Task Submitted</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $submitted; ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Task Checked</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $checked; ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Task Records</h6>
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                        </a>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-secondary"></i> Submit
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Check
                        </span>
                        <span class="mr-2">
    ...
    <script type="text/javascript">
        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: [0, 0, 0, 0, 0, 0, <?php echo $areachart; ?>, 0, 0, 0, 0, 0],
                }],
            },
            options: {
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ["Submitted", "Checked", "Approved", "Rejected"],
                datasets: [{
                    data: [<?php echo $submitted; ?>, <?php echo $checked; ?>, <?php echo $approved; ?>, <?php echo $rejected; ?>],
                    backgroundColor: ['#858796', '#36b9cc', '#1cc88a', '#f6c23e'],
                    hoverBackgroundColor: ['#5a5c69', '#2c9faf', '#17a673', '#17a673'],
