...
<head>
    ...
    <title><?php echo $title; ?> - CRM Urun Bangun Negeri</title>

    <!-- Custom fonts for this template-->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets'); ?>/images/logos.png">
            ...
            <li class="nav-item<?php if ($this->uri->segment(1) == 'task') echo ' active'; ?>">
                <a class="nav-link" href="<?php echo base_url('task'); ?>">
                    ...
                    <?php if ($this->session->userdata('privilege') == 2) {
                        echo '<span>Task Approval Form</span>';
                    } else if ($this->session->userdata('privilege') == 3) {
                        echo '<span>Task Checking Form</span>';
                    } else {
                        echo '<span>Task Form</span>';
                    } ?>
                </a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <?php foreach ($notif as $row) { ?>
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        ...
                                        <div>
                                            <div class="small text-gray-500"><?php echo date('j F Y', strtotime($row['createdate'])); ?></div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo base_url('assets'); ?>/images/<?php echo $user['photo']; ?>">
                            </a>
